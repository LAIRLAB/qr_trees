...
ilqr::CostFunc create_quadratic_cost(const Eigen::MatrixXd &Q, const Eigen::MatrixXd &R, const Eigen::VectorXd &goal_state)
{
    return [&Q, &R, &goal_state](const Eigen::VectorXd &x, const Eigen::VectorXd& u) -> double
    {
        ...
        const Eigen::VectorXd xdiff = goal_state - x;
